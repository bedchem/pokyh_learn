...
| `LEARN_AI_API_TIMEOUT_MS` | optional | longer BFF deadline for `/api/learn/ai/*` (defaults to 220s); a self-hosted, CPU-only vocabulary-sentence request can take longer than a normal API call, especially on a cold model start |
